...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Karma.date'
        db.alter_column(u'karma_karma', 'date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'karma.karma': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'karma_owner_set'", 'to': u"orm['auth.User']"}),
            'value': ('django.db.models.fields.IntegerField', [], {}),
            'voter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'karma_voter_set'", 'to': u"orm['auth.User']"})
        },
        u'karma.karmastatus': {
