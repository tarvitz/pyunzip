...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventWatch'
        db.create_table(u'news_eventwatch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_watch_set', to=orm['news.Event'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_watch_user_set', to=orm['accounts.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'news', ['EventWatch'])

        # Adding unique constraint on 'EventWatch', fields ['event', 'user']
        db.create_unique(u'news_eventwatch', ['event_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventWatch', fields ['event', 'user']
        db.delete_unique(u'news_eventwatch', ['event_id', 'user_id'])

        # Deleting model 'EventWatch'
        db.delete_table(u'news_eventwatch')
    ...
    models = {
        ...
        u'news.archivednews': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'archivednews'", 'to': u"orm['accounts.User']"}),
        ...
        u'news.event': {
            'Meta': {'ordering': "['-is_finished', 'date_start']", 'object_name': 'Event'},
            ...
            'league': ('django.db.models.fields.CharField', [], {'default': "'wh40k'", 'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'event_users_sets'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['accounts.User']"}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'event_place_set'", 'null': 'True', 'to': u"orm['news.EventPlace']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'game'", 'max_length': '16'})
        },
        u'news.eventplace': {
            'Meta': {'object_name': 'EventPlace'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'contacts': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '512'})
        },
        u'news.eventwatch': {
            'Meta': {'unique_together': "(('event', 'user'),)", 'object_name': 'EventWatch'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_watch_set'", 'to': u"orm['news.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_watch_user_set'", 'to': u"orm['accounts.User']"})
        },
        u'news.meating': {
            ...
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'meating_user_sets'", 'symmetrical': 'False', 'to': u"orm['accounts.User']"}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'meating_owner_set'", 'to': u"orm['accounts.User']"}),
        ...
        u'news.news': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_event': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'news'", 'to': u"orm['accounts.User']"}),
            'reason': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'resend': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'queued'", 'max_length': '32'}),
            'syntax': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
