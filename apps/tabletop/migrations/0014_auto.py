...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tabletop_wargear_model_units', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('wargear', models.ForeignKey(orm['tabletop.wargear'], null=False)),
            ('modelunit', models.ForeignKey(orm['tabletop.modelunit'], null=False))
        ))
        db.create_unique('tabletop_wargear_model_units', ['wargear_id', 'modelunit_id'])
