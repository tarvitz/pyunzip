...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.is_all_day'
        db.add_column(u'news_event', 'is_all_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Event.date_end'
        db.alter_column(u'news_event', 'date_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Event.is_all_day'
        db.delete_column(u'news_event', 'is_all_day')


        # Changing field 'Event.date_end'
        db.alter_column(u'news_event', 'date_end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 29, 0, 0)))
