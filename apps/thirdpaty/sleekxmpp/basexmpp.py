...
try:
    ...
    import apps.thirdpaty.sleekxmpp
#    pass

from apps.thirdpaty.sleekxmpp import plugins

from apps.thirdpaty.sleekxmpp.stanza import Message, Presence, Iq, Error
from apps.thirdpaty.sleekxmpp.stanza.roster import Roster
from apps.thirdpaty.sleekxmpp.stanza.nick import Nick
from apps.thirdpaty.sleekxmpp.stanza.htmlim import HTMLIM

from apps.thirdpaty.sleekxmpp.xmlstream import XMLStream, JID, tostring
from apps.thirdpaty.sleekxmpp.xmlstream import ET, register_stanza_plugin
...
class BaseXMPP(XMLStream):
    ...
    def register_plugin(self, plugin, pconfig={}, module=None):
        ...
        try:
            ...
            if not module:
                module = apps.thirdpaty.sleekxmpp.plugins
