...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'News.head_content'
        db.delete_column('news_news', 'head_content')

        # Deleting field 'ArchivedNews.head_content'
        db.delete_column('news_archivednews', 'head_content')


    def backwards(self, orm):
        # Adding field 'News.head_content'
        db.add_column('news_news', 'head_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArchivedNews.head_content'
        db.add_column('news_archivednews', 'head_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
