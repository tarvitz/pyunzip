...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Roster.codex'
        db.add_column('tabletop_roster', 'codex', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tabletop.Codex'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Roster.codex'
        db.delete_column('tabletop_roster', 'codex_id')
    ...
    models = {
        ...
        'tabletop.roster': {
            ...
            'codex': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tabletop.Codex']", 'null': 'True', 'blank': 'True'}),
