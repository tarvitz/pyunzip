...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tabletop_wargearrequirement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('amount_target', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wargear_require_targers', to=orm['tabletop.Wargear'])),
            ('require', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wargear_require', to=orm['tabletop.Wargear'])),
        ))
        db.send_create_signal('tabletop', ['WargearRequirement'])

        # Removing M2M table for field depends on 'Wargear'
        db.delete_table('tabletop_wargear_depends')


    def backwards(self, orm):
        # Deleting model 'WargearRequirement'
        db.delete_table('tabletop_wargearrequirement')

        # Adding M2M table for field depends on 'Wargear'
        db.create_table('tabletop_wargear_depends', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_wargear', models.ForeignKey(orm['tabletop.wargear'], null=False)),
            ('to_wargear', models.ForeignKey(orm['tabletop.wargear'], null=False))
        ))
        db.create_unique('tabletop_wargear_depends', ['from_wargear_id', 'to_wargear_id'])
    ...
    models = {
        ...
        'tabletop.wargearrequirement': {
            ...
            'amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'amount_target': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'require': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wargear_require'", 'to': "orm['tabletop.Wargear']"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wargear_require_targers'", 'to': "orm['tabletop.Wargear']"})
        },
        'wh.army': {
