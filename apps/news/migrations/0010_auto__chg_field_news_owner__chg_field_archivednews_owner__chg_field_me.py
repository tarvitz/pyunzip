...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'news_news', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

        # Changing field 'ArchivedNews.owner'
        db.alter_column(u'news_archivednews', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

        # Changing field 'Meating.owner'
        db.alter_column(u'news_meating', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

    def backwards(self, orm):

        # Changing field 'News.owner'
        db.alter_column(u'news_news', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'ArchivedNews.owner'
        db.alter_column(u'news_archivednews', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Meating.owner'
        db.alter_column(u'news_meating', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
