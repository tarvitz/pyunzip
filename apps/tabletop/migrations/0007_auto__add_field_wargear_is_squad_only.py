...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wargear.is_squad_only'
        db.add_column('tabletop_wargear', 'is_squad_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field blocks on 'Wargear'
        db.create_table('tabletop_wargear_blocks', (
        ...
        db.create_unique('tabletop_wargear_blocks', ['from_wargear_id', 'to_wargear_id'])


    def backwards(self, orm):
        # Deleting field 'Wargear.is_squad_only'
        db.delete_column('tabletop_wargear', 'is_squad_only')
    ...
    models = {
        ...
        'tabletop.wargear': {
            ...
            'blocks': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'blocks_rel_+'", 'to': "orm['tabletop.Wargear']"}),
