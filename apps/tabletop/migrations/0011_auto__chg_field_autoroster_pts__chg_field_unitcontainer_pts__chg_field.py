...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AutoRoster.pts'
        db.alter_column('tabletop_autoroster', 'pts', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'UnitContainer.pts'
        db.alter_column('tabletop_unitcontainer', 'pts', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'WargearContainer.pts'
        db.alter_column('tabletop_wargearcontainer', 'pts', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AutoRoster.pts'
        db.alter_column('tabletop_autoroster', 'pts', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'UnitContainer.pts'
        db.alter_column('tabletop_unitcontainer', 'pts', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'WargearContainer.pts'
        db.alter_column('tabletop_wargearcontainer', 'pts', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    ...
    models = {
        ...
        'tabletop.unitcontainer': {
            ...
            'pts': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
