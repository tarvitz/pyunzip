...
import re
from apps.thirdpaty import textile
...
class TestKnownValues(unittest.TestCase):
    xhtml_known_values = (
        ...
        ('I seriously *{color:red}blushed*\n'
         ...
         '<br />when I <em class="big">sprouted</em>'
         ' that<br />corn stalk from my<br />'
        ...
        ('h2()>. Bingo.',
         '\t<h2 style="padding-left:1em;padding-right:1em;text-align:right;">'
         'Bingo.</h2>'),

        ('h3()>[no]{color:red}. Bingo',
         '\t<h3 style="color:red;padding-left:1em;padding-right:1em;'
         'text-align:right;" lang="no">Bingo</h3>'),
        ...
        ('<div style="float:right;">\n\nh3. Sidebar\n\n'
         ...
         'page goes here and will<br />stay to the left of the<br />'
         'sidebar.</p>'),
        ...
        ('I searched "a search engine (Google)":http://google.com.',
         '\t<p>I searched <a href="http://google.com" title="Google">a search '
         'engine</a>.</p>'),

        ('I am crazy about "Hobix":hobix\nand "it\'s":hobix "all":hobix I'
         ' ever\n"link to":hobix!\n\n[hobix]http://hobix.com',
        ...
        ('!openwindow1.gif!:http://hobix.com/',
         '\t<p><a href="http://hobix.com/" class="img">'
         '<img src="openwindow1.gif" alt="" /></a></p>'),
        ...
        ('We use CSS(Cascading Style Sheets).',
         '\t<p>We use <acronym title="Cascading Style Sheets">CSS</acronym>.'
         '</p>'),
        ...
        ('!http://render.mathim.com/A%5EtAx%20%3D%20A%5Et%28Ax%29.!',
         '\t<p><img src="http://render.mathim.com/'
         'A%5EtAx%20%3D%20A%5Et%28Ax%29." alt="" /></p>'),
        ...
        ('Links (like "this":http://foo.com), are now mangled in 2.1.0, '
         'whereas 2.0 parsed them correctly.',
         '\t<p>Links (like <a href="http://foo.com">this</a>), '
         'are now mangled '
         'in 2.1.0, whereas 2.0 parsed them correctly.</p>'),
        ...
        ('"some text":http://www.example.com/?q=foo%20bar and more text',
         '\t<p><a href="http://www.example.com/?q=foo%20bar">some text</a>'
         ' and more text</p>'),
        ...
        ("p=. Où est l'école, l'église s'il vous plaît?",
         "\t<p style=\"text-align:center;\">Où est l&#8217;école,"
         "l&#8217;église s&#8217;il vous plaît?</p>"),

        ("p=. *_The_* _*Prisoner*_",
         """\t<p style="text-align:center;"><strong><em>The</em></strong>
         <em><strong>Prisoner</strong></em></p>"""),

        ("""p=. "An emphasised _word._" & "*A spanned phrase.*" """,
         """\t<p style="text-align:center;">&#8220;An emphasised
         <em>word.</em>&#8221; &amp; &#8220;<strong>A spanned phrase.</strong>
         &#8221; </p>"""),

        ("""p=. "*Here*'s a word!" """,
         """\t<p style="text-align:center;">&#8220;<strong>Here</strong>
         &#8217;s a word!&#8221; </p>"""),

        ("""p=. "Please visit our
        "Textile Test Page":http://textile.sitemonks.com" """,
         """\t<p style="text-align:center;">&#8220;Please visit our
         <a href="http://textile.sitemonks.com">Textile Test Page</a>&#8221;
         </p>"""),

        (u"""| Foreign EXPÓŅÉNTIAL |""",
         u"""\t<table>\n\t\t<tr>\n\t\t\t<td>Foreign
         <span class="caps">EXPÓŅÉNTIAL</span> </td>\n\t\t\t<td>\n\t\t</tr>
         \n\t</table>"""),

        (u"""p=. Tell me, what is
        AJAX(Asynchronous Javascript and XML), please?""",
         u"""\t<p style="text-align:center;">Tell me, what is
    ...
    html_known_values = (
        ...
        ("I'm %{color:red}unaware%\nof most soft drinks.",
         '\t<p>I&#8217;m <span style="color:red;">unaware'
         '</span><br>of most soft drinks.</p>'),
        ...
        ('I am crazy about "Hobix":hobix\nand "it\'s":hobix "all":hobix '
         'I ever\n"link to":hobix!\n\n[hobix]http://hobix.com',

         '\t<p>I am crazy about <a href="http://hobix.com">Hobix</a>'
         '<br>and <a href="http://hobix.com">it&#8217;s</a> '
         '<a href="http://hobix.com">all</a> I ever<br>'
         '<a href="http://hobix.com">link to</a>!</p>\n\n'),
        ...
        ('!>obake.gif!\n\nAnd others sat all round the small'
         ...
         '<br>machine and paid it to sing to them.</p>'),

        ('!http://render.mathim.com/A%5EtAx%20%3D%20A%5Et%28Ax%29.!',
         '\t<p>'
         '<img src="http://render.mathim.com/A%5EtAx%20%3D%20A%5Et%28Ax%29." '
         'alt=""></p>'),
...
class Tests(unittest.TestCase):
    def testFootnoteReference(self):
        ...
        self.assertTrue(
            re.search('^\t<p>YACC<sup class="footnote">'
                      '<a href="#fn[a-z0-9-]+">1</a></sup></p>', html)
        )

    def testFootnote(self):
        html = textile.textile(
            'This is covered elsewhere[1].\n\nfn1. Down here, '
            'in fact.\n\nfn2. Here is another footnote.'
        )
        self.assertTrue(
            re.search('^\t<p>This is covered elsewhere<sup class="footnote">'
                      '<a href="#fn[a-z0-9-]+">1</a>'
                      '</sup>.</p>\n\n\t<p id="fn[a-z0-9-]+" '
                      'class="footnote"><sup>1</sup>Down here, in fact.</p>'
                      '\n\n\t<p id="fn[a-z0-9-]+" class="footnote">'
                      '<sup>2</sup>Here is another footnote.</p>$', html)
        )

    def testURLWithHyphens(self):
        self.assertEqual(
            textile.textile('"foo":http://google.com/one--two'),
            '\t<p><a href="http://google.com/one--two">foo</a></p>'
        )

    def testIssue024TableColspan(self):
        self.assertEqual(
            textile.textile('|\\2. spans two cols |\n| col 1 | col 2 |'),
    ...
    def testPBAColspan(self):
        self.assertEqual(textile.Textile().pba(r'\3', element='td'),
                         ' colspan="3"')

    def testIssue002Escaping(self):
        foo = '"foo ==(bar)==":#foobar'
        self.assertEqual(textile.textile(foo),
                         '\t<p><a href="#foobar">foo (bar)</a></p>')
    ...
    def testURLWithParens(self):
        text = '"python":http://en.wikipedia.org/wiki/' \
               'Python_(programming_language)'
        expect = '\t<p><a href="http://en.wikipedia.org/wiki/' \
                 'Python_(programming_language)">python</a></p>'
    ...
    def testTableWithHyphenStyles(self):
        ...
        expect = '\t<table class="linkblog-thumbnail">\n\t\t<tr>\n\t\t\t' \
                 ...
                 'class="linkblog-thumbnail-cell">apple</td>' \
                 '\n\t\t\t<td>bear</td>\n\t\t' \
                 '</tr>\n\t</table>'
        result = textile.textile(text)
        self.assertEqual(result, expect)
    ...
    def testRestricted(self):
        ...
        result = textile.textile_restricted(test)
        expect = (
            "\t<p>Here is some text.<br />&#60;script&#62;"
            "alert('hello world&#8217;)&#60;/script&#62;</p>"
        )
    ...
    def testUnicodeFootnote(self):
        ...
        self.assertTrue(
            re.compile(u'^\t<p>текст<sup class="footnote">'
                       u'<a href="#fn[a-z0-9-]+">1</a></sup></p>',
                       re.U).search(html)
        )
    ...
    def testAutoLinking(self):
        ...
        result = (
            "\t<p>some text <a href=\"http://www.google.com\">"
    ...
    def testSanitize(self):
        ...
        test = (
            """<p style="width: expression(alert('evil'));">
            a paragraph of evil text</p>"""
        )
    ...
    def testImageSize(self):
        ...
        result = (
            '\t<p><img src="http://www.google.com/intl/en_ALL/images/srpr/'
            'logo1w.png" alt="" /></p>'
        )
