...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PolicyWarning'
        db.create_table(u'accounts_policywarning', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='warning_user_set', to=orm['accounts.User'])),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True, blank=True)),
            ...
            ('date_expired', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('is_expired', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'accounts', ['PolicyWarning'])


    def backwards(self, orm):
        # Deleting model 'PolicyWarning'
        db.delete_table(u'accounts_policywarning')
    ...
    models = {
        ...
        u'accounts.policywarning': {
            'Meta': {'object_name': 'PolicyWarning'},
