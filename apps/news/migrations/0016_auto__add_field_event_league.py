...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.league'
        db.add_column(u'news_event', 'league',
                      self.gf('django.db.models.fields.CharField')(default='wh40k', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.league'
        db.delete_column(u'news_event', 'league')
    ...
    models = {
        ...
        u'news.event': {
            ...
            'league': ('django.db.models.fields.CharField', [], {'default': "'wh40k'", 'max_length': '32'}),
