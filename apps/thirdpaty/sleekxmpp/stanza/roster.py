...
from apps.thirdpaty.sleekxmpp.stanza import Iq
from apps.thirdpaty.sleekxmpp.xmlstream import JID
from apps.thirdpaty.sleekxmpp.xmlstream import ET, ElementBase, register_stanza_plugin
