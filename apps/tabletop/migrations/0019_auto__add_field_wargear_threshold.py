...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wargear.threshold'
        db.add_column('tabletop_wargear', 'threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding M2M table for field combines on 'Wargear'
        db.create_table('tabletop_wargear_combines', (
        ...
        db.create_unique('tabletop_wargear_combines', ['from_wargear_id', 'to_wargear_id'])


    def backwards(self, orm):
        # Deleting field 'Wargear.threshold'
        db.delete_column('tabletop_wargear', 'threshold')
