...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'files_image', 'thumbnail')
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Image.thumbnail'
        db.add_column(u'files_image', 'thumbnail',
