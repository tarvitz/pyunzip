...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelUnit.mwr_amount'
        db.add_column('tabletop_modelunit', 'mwr_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'MWRUnit.amount'
        db.delete_column('tabletop_mwrunit', 'amount')


    def backwards(self, orm):
        # Deleting field 'ModelUnit.mwr_amount'
        db.delete_column('tabletop_modelunit', 'mwr_amount')

        # Adding field 'MWRUnit.amount'
        db.add_column('tabletop_mwrunit', 'amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)
    ...
    models = {
        ...
        'tabletop.modelunit': {
            ...
            'mwr_amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
