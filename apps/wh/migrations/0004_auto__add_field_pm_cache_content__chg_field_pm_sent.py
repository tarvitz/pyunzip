...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PM.cache_content'
        db.add_column(u'wh_pm', 'cache_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'PM.sent'
        db.alter_column(u'wh_pm', 'sent', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'PM.cache_content'
        db.delete_column(u'wh_pm', 'cache_content')


        # Changing field 'PM.sent'
        db.alter_column(u'wh_pm', 'sent', self.gf('django.db.models.fields.DateTimeField')())
