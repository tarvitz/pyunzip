...
from apps.thirdpaty.sleekxmpp.thirdparty.statemachine import StateMachine
from apps.thirdpaty.sleekxmpp.xmlstream import Scheduler, tostring
...
if sys.version_info < (3, 0):
    from apps.thirdpaty.sleekxmpp.xmlstream.filesocket import FileSocket, Socket26
...
class XMLStream(object):
    ...
    def add_handler(self, mask, pointer, name=None, disposable=False,
        ...
        from apps.thirdpaty.sleekxmpp.xmlstream.matcher import MatchXMLMask
        from apps.thirdpaty.sleekxmpp.xmlstream.handler import XMLCallback
