...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Wargear.model_unit'
        db.delete_column('tabletop_wargear', 'model_unit_id')


    def backwards(self, orm):
        # Adding field 'Wargear.model_unit'
        db.add_column('tabletop_wargear', 'model_unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='wargear', to=orm['tabletop.ModelUnit']),
                      keep_default=False)
