...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WargearRequirement.threshold'
        db.add_column('tabletop_wargearrequirement', 'threshold',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WargearRequirement.threshold'
        db.delete_column('tabletop_wargearrequirement', 'threshold')
