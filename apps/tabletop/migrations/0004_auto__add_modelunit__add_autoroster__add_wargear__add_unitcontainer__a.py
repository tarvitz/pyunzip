...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tabletop_modelunit', (
        ...
        db.send_create_signal('tabletop', ['ModelUnit'])

        # Adding model 'AutoRoster'
        db.create_table('tabletop_autoroster', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ...
        db.send_create_signal('tabletop', ['AutoRoster'])

        # Adding model 'Wargear'
        db.create_table('tabletop_wargear', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=4096)),
            ('model_unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wargear', to=orm['tabletop.ModelUnit'])),
            ('pts', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('tabletop', ['Wargear'])

        # Adding model 'UnitContainer'
        db.create_table('tabletop_unitcontainer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('pts', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('roster', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'unti_containers', to=orm['tabletop.AutoRoster'])),
        ))
        db.send_create_signal('tabletop', ['UnitContainer'])

        # Adding model 'WargearContainer'
        db.create_table('tabletop_wargearcontainer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('pts', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.send_create_signal('tabletop', ['WargearContainer'])

        # Adding model 'Army'
        db.create_table('tabletop_army', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('tabletop', ['Army'])


    def backwards(self, orm):
        # Deleting model 'ModelUnit'
        db.delete_table('tabletop_modelunit')

        # Deleting model 'AutoRoster'
        db.delete_table('tabletop_autoroster')

        # Deleting model 'Wargear'
        db.delete_table('tabletop_wargear')

        # Deleting model 'UnitContainer'
        db.delete_table('tabletop_unitcontainer')

        # Deleting model 'WargearContainer'
        db.delete_table('tabletop_wargearcontainer')

        # Deleting model 'Army'
        db.delete_table('tabletop_army')
    ...
    models = {
        ...
        'tabletop.unitcontainer': {
            ...
            'roster': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'unti_containers'", 'to': "orm['tabletop.AutoRoster']"})
        },
        'tabletop.wargear': {
