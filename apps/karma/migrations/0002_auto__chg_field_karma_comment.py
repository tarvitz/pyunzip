...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Karma.comment'
        db.alter_column(u'karma_karma', 'comment', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Karma.comment'
        db.alter_column(u'karma_karma', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'karma.karma': {
            ...
            'voter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'voter'", 'to': u"orm['auth.User']"})
        },
        u'karma.karmastatus': {
