# coding: utf-8
default_app_config = 'apps.comments.apps.CommentConfig'
...
def get_comment_app():
    ...
    try:
        ...
        raise ImproperlyConfigured(
            "The COMMENTS_APP setting refers to a "
            "non-existing package. (%s)" % e
        )
...
def get_form_target():
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(
        ...
        return urlresolvers.reverse(
            "apps.comments.views.comments.post_comment"
        )
...
def get_flag_url(comment):
    ...
    """
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(
            get_comment_app(), "get_flag_url"):
        return get_comment_app().get_flag_url(comment)
    else:
        return urlresolvers.reverse("apps.comments.views.moderation.flag",
                                    args=(comment.id,))
...
def get_delete_url(comment):
    ...
    """
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(
            get_comment_app(), "get_delete_url"):
        return get_comment_app().get_delete_url(comment)
    else:
        return urlresolvers.reverse("apps.comments.views.moderation.delete",
                                    args=(comment.id,))
...
def get_approve_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(
        ...
        return urlresolvers.reverse("apps.comments.views.moderation.approve",
                                    args=(comment.id,))
