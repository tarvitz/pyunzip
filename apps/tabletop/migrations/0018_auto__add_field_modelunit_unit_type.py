...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelUnit.unit_type'
        db.add_column('tabletop_modelunit', 'unit_type',
                      self.gf('django.db.models.fields.CharField')(default='infantry', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelUnit.unit_type'
        db.delete_column('tabletop_modelunit', 'unit_type')
