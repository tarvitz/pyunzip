...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.skin'
        db.delete_column(u'accounts_user', 'skin_id')


    def backwards(self, orm):
        # Adding field 'User.skin'
        db.add_column(u'accounts_user', 'skin',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wh.Skin'], null=True, blank=True),
                      keep_default=False)
