...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.resend'
        db.add_column(u'news_news', 'resend',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ArchivedNews.resend'
        db.add_column(u'news_archivednews', 'resend',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.resend'
        db.delete_column(u'news_news', 'resend')

        # Deleting field 'ArchivedNews.resend'
        db.delete_column(u'news_archivednews', 'resend')
