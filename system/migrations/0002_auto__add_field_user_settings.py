...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auth_user', 'settings', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.settings'
        db.delete_column('auth_user', 'settings')
