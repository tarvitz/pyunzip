...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Karma.voter'
        db.alter_column(u'karma_karma', 'voter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

        # Changing field 'Karma.user'
        db.alter_column(u'karma_karma', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

        # Changing field 'Karma.date'
        db.alter_column(u'karma_karma', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Karma.voter'
        db.alter_column(u'karma_karma', 'voter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Karma.user'
        db.alter_column(u'karma_karma', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Karma.date'
        db.alter_column(u'karma_karma', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'karma.karma': {
            'Meta': {'ordering': "['-date']", 'object_name': 'Karma'},
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'karma_owner_set'", 'to': u"orm['accounts.User']"}),
            'value': ('django.db.models.fields.IntegerField', [], {}),
            'voter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'karma_voter_set'", 'to': u"orm['accounts.User']"})
        },
        u'karma.karmastatus': {
            'Meta': {'object_name': 'KarmaStatus'},
            'codename': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_general': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_humor': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
