...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'karma_karma', (
            ...
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='voter', to=orm['auth.User'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'karma', ['Karma'])

        # Adding model 'KarmaStatus'
        db.create_table(u'karma_karmastatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('value', self.gf('django.db.models.fields.IntegerField')()),
            ('is_humor', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'karma', ['KarmaStatus'])

        # Adding M2M table for field side on 'KarmaStatus'
        db.create_table(u'karma_karmastatus_side', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('karmastatus', models.ForeignKey(orm[u'karma.karmastatus'], null=False)),
            ('side', models.ForeignKey(orm[u'wh.side'], null=False))
        ))
        db.create_unique(u'karma_karmastatus_side', ['karmastatus_id', 'side_id'])


    def backwards(self, orm):
        # Deleting model 'Karma'
        db.delete_table(u'karma_karma')

        # Deleting model 'KarmaStatus'
        db.delete_table(u'karma_karmastatus')

        # Removing M2M table for field side on 'KarmaStatus'
        db.delete_table('karma_karmastatus_side')
