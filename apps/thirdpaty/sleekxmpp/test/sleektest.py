...
from apps.thirdpaty.sleekxmpp import ClientXMPP, ComponentXMPP
from apps.thirdpaty.sleekxmpp.stanza import Message, Iq, Presence
from apps.thirdpaty.sleekxmpp.test import TestSocket, TestLiveSocket
from apps.thirdpaty.sleekxmpp.xmlstream import StanzaBase, ET, register_stanza_plugin
