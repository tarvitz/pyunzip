...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PolicyWarning.created_on'
        db.alter_column(u'accounts_policywarning', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'PM.title'
        db.alter_column(u'accounts_pm', 'title', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'PolicyWarning.created_on'
        db.alter_column(u'accounts_policywarning', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'PM.title'
        db.alter_column(u'accounts_pm', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

    models = {
        u'accounts.pm': {
            'Meta': {'ordering': "['-sent']", 'object_name': 'PM'},
            ...
            'syntax': ('django.db.models.fields.CharField', [], {'default': "'textile'", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
        u'accounts.policywarning': {
            'Meta': {'ordering': "['-date_expired']", 'object_name': 'PolicyWarning'},
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '4096', 'null': 'True', 'blank': 'True'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_expired': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'warning_user_set'", 'to': u"orm['accounts.User']"})
        },
        u'accounts.user': {
