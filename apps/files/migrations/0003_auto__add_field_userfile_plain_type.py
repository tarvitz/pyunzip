...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserFile.plain_type'
        db.add_column(u'files_userfile', 'plain_type',
                      self.gf('django.db.models.fields.CharField')(default='octet/stream', max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserFile.plain_type'
        db.delete_column(u'files_userfile', 'plain_type')
    ...
    models = {
        ...
        u'files.replay': {
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {}),
            'version': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['files.Version']"}),
        ...
        u'files.version': {
            ...
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['files.Game']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
