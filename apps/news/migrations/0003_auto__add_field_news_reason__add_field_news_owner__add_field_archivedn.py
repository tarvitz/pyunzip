...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.reason'
        db.add_column('news_news', 'reason',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'News.owner'
        db.add_column('news_news', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='news', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ArchivedNews.reason'
        db.add_column('news_archivednews', 'reason',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArchivedNews.owner'
        db.add_column('news_archivednews', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='archivednews', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.reason'
        db.delete_column('news_news', 'reason')

        # Deleting field 'News.owner'
        db.delete_column('news_news', 'owner_id')

        # Deleting field 'ArchivedNews.reason'
        db.delete_column('news_archivednews', 'reason')

        # Deleting field 'ArchivedNews.owner'
        db.delete_column('news_archivednews', 'owner_id')
    ...
    models = {
        ...
        'news.archivednews': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'archivednews'", 'to': "orm['auth.User']"}),
        ...
        'news.meating': {
            ...
            'syntax': ('django.db.models.fields.CharField', [], {'default': "'bb-code'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        'news.news': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_event': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'news'", 'to': "orm['auth.User']"}),
            'reason': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'syntax': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
