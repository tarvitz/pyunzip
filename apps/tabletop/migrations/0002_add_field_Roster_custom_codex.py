...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tabletop_roster', 'custom_codex', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Roster.custom_codex'
        db.delete_column('tabletop_roster', 'custom_codex')
