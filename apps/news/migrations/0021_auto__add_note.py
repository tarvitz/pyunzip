...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'news_note', (
            ...
            ('expired_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 1, 21, 0, 0))),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('for_authenticated_only', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sign', self.gf('django.db.models.fields.BooleanField')()),
            ('type', self.gf('django.db.models.fields.CharField')(default='success', max_length=64)),
        ))
        db.send_create_signal(u'news', ['Note'])


    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table(u'news_note')
    ...
    models = {
        ...
        u'news.note': {
            ...
            'content': ('django.db.models.fields.TextField', [], {}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'expired_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 21, 0, 0)'}),
            'for_authenticated_only': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sign': ('django.db.models.fields.BooleanField', [], {}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'success'", 'max_length': '64'})
        },
        u'wh.army': {
