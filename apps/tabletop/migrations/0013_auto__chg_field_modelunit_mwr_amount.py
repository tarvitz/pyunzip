...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModelUnit.mwr_amount'
        db.alter_column('tabletop_modelunit', 'mwr_amount', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ModelUnit.mwr_amount'
        db.alter_column('tabletop_modelunit', 'mwr_amount', self.gf('django.db.models.fields.PositiveIntegerField')())
