...
urlpatterns = patterns('apps.wh.views',
    ...
    #url(r'^test/send_pm/$', 'send_pm'),
    #url(r'^test/view_pm/$', 'view_pm'),
    ...
    # real obsolete, need to be purged
    #url(r'^feedback/wishes/$', 'view_wish_list'),
    #url(r'^feedback/wishes/add/$', 'add_wish'),
    #url(r'^feedback/wishes/(?P<wish_id>\d+)/(?P<filter>(approve|publish|unapprove|unpublish|done))/$', 'manage_wish'), 
