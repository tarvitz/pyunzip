...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tabletop_mwrunit', (
            ...
            ('wargear', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requirements', to=orm['tabletop.Wargear'])),
        ))
        db.send_create_signal('tabletop', ['MWRUnit'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tabletop_mwrunit')
    ...
    models = {
        ...
        'tabletop.mwrunit': {
            ...
            'wargear': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requirements'", 'to': "orm['tabletop.Wargear']"})
        },
        'tabletop.roster': {
        ...
        'tabletop.wargear': {
            ...
            'depends': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'depends_rel_+'", 'to': "orm['tabletop.Wargear']"}),
