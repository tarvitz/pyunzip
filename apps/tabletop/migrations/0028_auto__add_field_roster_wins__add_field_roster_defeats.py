...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Roster.wins'
        db.add_column(u'tabletop_roster', 'wins',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Roster.defeats'
        db.add_column(u'tabletop_roster', 'defeats',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Roster.wins'
        db.delete_column(u'tabletop_roster', 'wins')

        # Deleting field 'Roster.defeats'
        db.delete_column(u'tabletop_roster', 'defeats')
    ...
    models = {
        ...
        u'tabletop.battlereport': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'battle_report_set'", 'to': u"orm['auth.User']"}),
