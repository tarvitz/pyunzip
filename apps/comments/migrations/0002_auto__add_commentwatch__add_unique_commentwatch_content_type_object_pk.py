...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentWatch'
        db.create_table(u'comments_commentwatch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='content_type_set_for_commentwatch', to=orm['contenttypes.ContentType'])),
            ('object_pk', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comment_watch_set', null=True, to=orm['comments.Comment'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment_watch_user_set', to=orm['accounts.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('is_disabled', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'comments', ['CommentWatch'])

        # Adding unique constraint on 'CommentWatch', fields ['content_type', 'object_pk', 'user']
        db.create_unique(u'comments_commentwatch', ['content_type_id', 'object_pk', 'user_id'])

        # Adding field 'Comment.syntax'
        db.add_column('django_comments', 'syntax',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Comment.cache_comment'
        db.add_column('django_comments', 'cache_comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Comment.ip_address'
        db.alter_column('django_comments', 'ip_address', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'CommentWatch', fields ['content_type', 'object_pk', 'user']
        db.delete_unique(u'comments_commentwatch', ['content_type_id', 'object_pk', 'user_id'])

        # Deleting model 'CommentWatch'
        db.delete_table(u'comments_commentwatch')

        # Deleting field 'Comment.syntax'
        db.delete_column('django_comments', 'syntax')

        # Deleting field 'Comment.cache_comment'
        db.delete_column('django_comments', 'cache_comment')


        # Changing field 'Comment.ip_address'
        db.alter_column('django_comments', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))
