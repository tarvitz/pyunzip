...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BattleReport.deployment'
        db.add_column(u'tabletop_battlereport', 'deployment',
                      self.gf('django.db.models.fields.CharField')(default='dow', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BattleReport.deployment'
        db.delete_column(u'tabletop_battlereport', 'deployment')
