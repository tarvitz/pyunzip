...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.league'
        db.alter_column(u'news_event', 'league', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Event.league'
        db.alter_column(u'news_event', 'league', self.gf('django.db.models.fields.CharField')(max_length=32))
