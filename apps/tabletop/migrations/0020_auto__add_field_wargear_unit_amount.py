...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wargear.unit_amount'
        db.add_column('tabletop_wargear', 'unit_amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wargear.unit_amount'
        db.delete_column('tabletop_wargear', 'unit_amount')
