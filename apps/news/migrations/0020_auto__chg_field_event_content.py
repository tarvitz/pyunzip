...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'news_event', 'content', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Event.content'
        db.alter_column(u'news_event', 'content', self.gf('django.db.models.fields.CharField')(max_length=4096))
