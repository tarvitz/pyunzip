...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'core_announcement_users'))

        # Removing M2M table for field notified_users on 'Announcement'
        db.delete_table(db.shorten_name(u'core_announcement_notified_users'))
        ...
        # Changing field 'UserSID.user'
        db.alter_column(u'core_usersid', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'core_announcement_users')
        ...
        m2m_table_name = db.shorten_name(u'core_announcement_notified_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('announcement', models.ForeignKey(orm[u'core.announcement'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ...
        # Changing field 'UserSID.user'
        db.alter_column(u'core_usersid', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'core.usersid': {
            ...
            'expired_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
