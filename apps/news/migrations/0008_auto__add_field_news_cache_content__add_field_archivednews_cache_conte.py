...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.cache_content'
        db.add_column(u'news_news', 'cache_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArchivedNews.cache_content'
        db.add_column(u'news_archivednews', 'cache_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.cache_content'
        db.delete_column(u'news_news', 'cache_content')

        # Deleting field 'ArchivedNews.cache_content'
        db.delete_column(u'news_archivednews', 'cache_content')
