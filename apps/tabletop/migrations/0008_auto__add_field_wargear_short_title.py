...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Wargear.short_title'
        db.add_column('tabletop_wargear', 'short_title',
                      self.gf('django.db.models.fields.CharField')(default='unkwn', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wargear.short_title'
        db.delete_column('tabletop_wargear', 'short_title')
