...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'news_eventplace', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('contacts', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal(u'news', ['EventPlace'])

        # Adding field 'Event.place'
        db.add_column(u'news_event', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_place_set', null=True, to=orm['news.EventPlace']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventPlace'
        db.delete_table(u'news_eventplace')

        # Deleting field 'Event.place'
        db.delete_column(u'news_event', 'place_id')
