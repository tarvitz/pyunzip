...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'files_image', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

        # Changing field 'UserFile.owner'
        db.alter_column(u'files_userfile', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Image.owner'
        db.alter_column(u'files_image', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'UserFile.owner'
        db.alter_column(u'files_userfile', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'files.image': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['files.Gallery']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'files.userfile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_file_set'", 'to': u"orm['accounts.User']"}),
