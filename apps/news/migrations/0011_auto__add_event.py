...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'news', ['Event'])

        # Adding M2M table for field participants on 'Event'
        m2m_table_name = db.shorten_name(u'news_event_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'news.event'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'news_event')

        # Removing M2M table for field participants on 'Event'
        db.delete_table(db.shorten_name(u'news_event_participants'))
