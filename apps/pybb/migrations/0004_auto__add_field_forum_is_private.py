...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pybb_forum', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field participants on 'Forum'
        m2m_table_name = db.shorten_name(u'pybb_forum_participants')
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'pybb_forum', 'is_private')

        # Removing M2M table for field participants on 'Forum'
        db.delete_table(db.shorten_name(u'pybb_forum_participants'))
    ...
    models = {
        ...
        u'pybb.forum': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'forum_user_sets'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            'position': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
