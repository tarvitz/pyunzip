...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('nickname', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, blank=True)),
            ...
            ('jid', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True)),
            ('uin', self.gf('django.db.models.fields.IntegerField')(max_length=12, null=True, blank=True)),
            ('about', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ...
            ('settings', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True)),
        ))
        ...
        m2m_table_name = db.shorten_name(u'accounts_user_ranks')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'accounts.user'], null=False)),
            ('rank', models.ForeignKey(orm[u'wh.rank'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'rank_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'accounts_user_ranks'))
