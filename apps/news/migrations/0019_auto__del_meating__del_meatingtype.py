...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'news_meating')

        # Removing M2M table for field members on 'Meating'
        db.delete_table(db.shorten_name(u'news_meating_members'))

        # Deleting model 'MeatingType'
        db.delete_table(u'news_meatingtype')


    def backwards(self, orm):
        # Adding model 'Meating'
        db.create_table(u'news_meating', (
            ('syntax', self.gf('django.db.models.fields.CharField')(default='textile', max_length=20, null=True, blank=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='meating_owner_set', to=orm['accounts.User'])),
        ...
        db.send_create_signal(u'news', ['Meating'])

        # Adding M2M table for field members on 'Meating'
        m2m_table_name = db.shorten_name(u'news_meating_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meating', models.ForeignKey(orm[u'news.meating'], null=False)),
            ('user', models.ForeignKey(orm[u'accounts.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['meating_id', 'user_id'])

        # Adding model 'MeatingType'
        db.create_table(u'news_meatingtype', (
            ('codename', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'news', ['MeatingType'])
